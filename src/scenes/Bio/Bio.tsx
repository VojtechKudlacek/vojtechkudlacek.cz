...
const Bio: FunctionComponent = () => {
	...
	return (
		<>
			...
			<Content>
				<TextSection title="A Little About Me" delayIn={200} delayOut={500} requiredWidth={412}>
				...
				<TextSection title="Some Professional Background" delayIn={300} delayOut={400} requiredWidth={653}>
				...
				<TextSection title="Free Time?" delayIn={400} delayOut={300} requiredWidth={490}>
				...
				<TextSection title="Epilogue" delayIn={500} delayOut={200} requiredWidth={305}>
